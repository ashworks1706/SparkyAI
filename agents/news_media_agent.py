        ...
        try:
            ...
            for part in response.parts:
                if hasattr(part, 'function_call') and part.function_call:
                    ...
                    self.firestore.update_message("news_media_agent_message", f"Function called {part.function_call}  Function Response {final_response} ")
                elif hasattr(part, 'text') and part.text.strip():
                    text = part.text.strip()
                    self.firestore.update_message("news_media_agent_message", f"Text Response : {text}")
