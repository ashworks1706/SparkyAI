  ...
  genai.protos.FunctionDeclaration(
    ...
    async def execute_function(self, function_call):
        ...
        if function_name in function_mapping:
            ...
            self.logger.info(f"Library : Function loop response : {func_response}")
    ...
    async def determine_action(self,instruction_to_agent:str,special_instructions:str) -> str:
        ...
        try:
            ...
            for part in response.parts:
                if hasattr(part, 'function_call') and part.function_call:
                    ...
                    self.firestore.update_message("library_agent_message", f"Function called {part.function_call}\n Function Response {final_response} ")
        ...
        # Return only the final message
            ...
            self.logger.error(f"Internal Error @ Library Model : {str(e)}")
