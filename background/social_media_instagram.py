...
class Social_Media_Instagram:
    def __init__(self):
        ...
        self.account_OBJECTs = {
            ...
            "@SunDevilAthletics": [
                "https://www.instagram.com/sundevilathletics/",
            ],
            "@SparkySunDevil": [
            ...
            "@ASUAlumni": [
                "https://www.instagram.com/asu_alumni/",
            ],
            "@ASUEngineering": [
                "https://www.instagram.com/asuengineering/",
            ],
        }
    ...
    async def get_latest_social_media_updates(self, account_name: list, search_bar_query: Optional[str] = None):
        ...
        for url in final_search_array:
            try:
                search_url = url
                if search_bar_query:
                    # Instagram doesn't support direct search in URL, but we'll keep the pattern
                    # In a real implementation, you might need to use Instagram API or alternative methods
                ...
                self.social_media_docs.append({
                    ...
                    "search_context": f"Instagram updates from {url} for {doc_title}",
                    "title": doc_title,
                })
    ...
    async def perform_web_search(self):
        """
        Comprehensive background scraping for Instagram updates from multiple accounts
        ...
        # Common search queries for Instagram content
        search_terms = [
            "event",
            "campus",
            "student",
