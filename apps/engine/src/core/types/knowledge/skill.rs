...
//!
//! A skill is parameters, an ordered list of steps, and the domain it applies to. It is
//! reviewed before it is offered, so the model reads one and runs it with the capabilities it
//! already has.
